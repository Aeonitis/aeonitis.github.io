  ...
  <div id="app">
    ...
    <div class="color-settings-panel" :class="{ 'hidden': !showColorPanel }">
      ...
      <div class="panel-buttons">
        <button @click="saveColorScheme" class="color-panel-btn">Save</button>
        <button @click="resetColorScheme" class="color-panel-btn">Reset</button>
      </div>
